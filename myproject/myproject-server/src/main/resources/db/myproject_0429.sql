...
-- ----------------------------
INSERT INTO `sys_article` VALUES (2049152412669284354, '我的第一篇文章', NULL, NULL, 0);
...
CREATE TABLE `sys_article_content`  (
  ...
  `content` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci NULL COMMENT '文章内容',
  `content_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci NULL DEFAULT NULL COMMENT '文章url',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `sys_article_content` VALUES (307552632405622784, NULL, '文章呢欧容是对方犯规被罚火车', 'http://192.168.99.100:9000/my-bucket/c01d98f8-870c-425a-8f3e-77315c032df6.md');
INSERT INTO `sys_article_content` VALUES (2049156435493359618, NULL, '12', NULL);
INSERT INTO `sys_article_content` VALUES (2049161642591752193, NULL, '文章内容2', NULL);
...
-- ----------------------------
INSERT INTO `sys_category` VALUES (307182234019168256, '分类2', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_german2_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (2001, '分类管理', 's', 'C', 1, 2, '/blog/category', 'blog/category/index', NULL, 0);
INSERT INTO `sys_menu` VALUES (2002, '标签管理', 's', 'C', 99, 2, '/blog/tag', 'blog/tag/index', NULL, 0);
INSERT INTO `sys_menu` VALUES (2003, '文章管理', 's', 'C', 99, 2, '/blog/article', 'blog/article/index', NULL, 0);
INSERT INTO `sys_menu` VALUES (2004, '内容管理', 's', 'C', 99, 2, '/blog/content', 'blog/content/index', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 307552632485183489 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
-- Records of sys_tag
-- ----------------------------
INSERT INTO `sys_tag` VALUES (2048796667524272129, '标签1', NULL);
INSERT INTO `sys_tag` VALUES (7346097769171390464, '标签222', NULL);
